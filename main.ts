function checkIFright (num: number) {
    game.splash(game.askForNumber(num))
    if (true) {
...
scene.setBackgroundImage(img`
    ...
    `)
let card1 = sprites.create(assets.image`card`, SpriteKind.Player)
card1.setPosition(25, 55)
let card2 = sprites.create(assets.image`card`, SpriteKind.Player)
card2.setPosition(60, 55)
let card3 = sprites.create(assets.image`card`, SpriteKind.Player)
card3.setPosition(100, 55)
let card4 = sprites.create(assets.image`card`, SpriteKind.Player)
card4.setPosition(135, 55)
